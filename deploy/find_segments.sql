SELECT seg."Id", seg."SessionId", seg."Title", seg."StartTime", seg."EndTime", seg."OrderIndex"
FROM tenant_demo."Segments" seg
...
ORDER BY seg."SessionId", seg."OrderIndex";

SELECT la."Id", la."SegmentId", la."Type", la."Title", la."StartTime", la."Metadata"
